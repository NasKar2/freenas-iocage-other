...
Scripts to create an iocage jail on Freenas 11.1U4 from scratch in separate jails for Unifi, Emby, Wordpress, Jackett, Prowlarr, UrBackup, Transmission, Handbrake, LazyLibrarian Duplicati and Backup/Restore Wordpress
